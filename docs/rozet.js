...
function LG_rozet(d, p, kv, pv){
  ...
  return [
   {e:"🌱",a:"İlk Adım",z:1,       s:"10 kelime",              v:d.length>=10},
   {e:"🔟",a:"Elli",z:1,           s:"50 kelime",              v:d.length>=50},
   {e:"💯",a:"Yüzler",z:1,         s:"100 kelime",             v:d.length>=100},
   {e:"🥇",a:"Üç Yüz",z:2,         s:"300 kelime",             v:d.length>=300},
   {e:"🎯",a:"Keskin Nişancı",z:2, s:"10 kelime ilk tahminde", v:ilk>=10},
   {e:"🏹",a:"Usta Nişancı",z:3,   s:"30 kelime ilk tahminde", v:ilk>=30},
   {e:"🔥",a:"Seri",z:2,           s:"5 kelime üst üste",      v:enSeri>=5},
   {e:"⚡",a:"Uzun Seri",z:3,      s:"10 kelime üst üste",     v:enSeri>=10},
   {e:"🌟",a:"Efsane Seri",z:4,    s:"20 kelime üst üste",     v:enSeri>=20},
   {e:"💎",a:"Kusursuz",z:3,       s:"son 10 kelimenin hepsi", v:kusursuz},
   {e:"👑",a:"K Fatihi",z:3,       s:"K'de 8 kelime, %70+",    v:gk.t>=8 && gk.o>=70},
   {e:"🛡",a:"S Fatihi",z:3,       s:"S'de 8 kelime, %70+",    v:gs.t>=8 && gs.o>=70},
   {e:"🗝",a:"A Fatihi",z:3,       s:"A'da 8 kelime, %70+",    v:ga.t>=8 && ga.o>=70},
   {e:"4️⃣",a:"Dörtlü Ustası",z:3,  s:"4 harflide 30, %80+",    v:g4.t>=30&&g4.o>=80},
   {e:"5️⃣",a:"Beşli Ustası",z:3,   s:"5 harflide 30, %70+",    v:g5.t>=30&&g5.o>=70},
   {e:"6️⃣",a:"Altılı Cesareti",z:2,s:"6 harflide 15 kelime",   v:g6.t>=15},
   {e:"7️⃣",a:"Süper Lingo",z:3,    s:"7 harflide 5 kelime",    v:g7.t>=5},
   {e:"📚",a:"Dört Uzunluk",z:2,   s:"her uzunluktan 5 kelime",
     v:g4.t>=5&&g5.t>=5&&g6.t>=5&&g7.t>=5},
   {e:"🎖",a:"Zor Harfler",z:3,    s:"A E İ K M S T Y'den 40", v:zorSay>=40},
   {e:"🚀",a:"Hızlı",z:2,          s:"ortalama 2 tahmin altı", v:d.length>=20 && ort<=2},
   {e:"⏳",a:"Sabırlı",z:2,        s:"son hakta 5 kelime",     v:sonhak>=5},
   {e:"♻️",a:"İkinci Şans",z:2,    s:"takıldığın kelimeyi bilmek", v:ikinci},
   {e:"🎓",a:"Tam Ders",z:3,       s:"bir günde 30 kelime",    v:enYogun>=30},
   {e:"🏃",a:"Maraton",z:4,        s:"bir günde 50 kelime",    v:enYogun>=50},
   {e:"🌙",a:"Gece Kuşu",z:1,      s:"gece 22-04 arası",       v:saatVar(22,4)},
   {e:"🌅",a:"Sabahçı",z:1,        s:"sabah 05-09 arası",      v:saatVar(5,9)},
   {e:"📅",a:"Azimli",z:2,         s:"4 ayrı günde çalışma",   v:gunler>=4},
   {e:"🗓",a:"Programlı",z:4,      s:"planın tüm görevleri",   v:yapilan>=LG_GOREVSAY},
   {e:"🌗",a:"Ç Fatihi",z:3,       s:"Ç'de 8 kelime, %70+",    v:gc.t>=8 && gc.o>=70},
   {e:"🐝",a:"T Fatihi",z:3,       s:"T'de 8 kelime, %70+",    v:gt.t>=8 && gt.o>=70},
   {e:"🦅",a:"B Fatihi",z:3,       s:"B'de 8 kelime, %70+",    v:gb.t>=8 && gb.o>=70},
   {e:"🧭",a:"On Harf",z:3,        s:"10 harften 5'er kelime", v:besHarf>=10},
   {e:"🗺",a:"Alfabe Gezgini",z:3, s:"20 farklı harf",         v:harfCesit>=20},
   {e:"🏔",a:"Beş Yüz",z:3,        s:"500 kelime",             v:d.length>=500},
   {e:"🌊",a:"Bin",z:4,            s:"1000 kelime",            v:d.length>=1000},
   {e:"🎬",a:"Yoğun Gün",z:5,      s:"bir günde 100 kelime",   v:enYogun>=100},
   {e:"🧨",a:"Hız Rekoru",z:4,     s:"ortalama 1,5 tahmin altı", v:d.length>=20 && ort<=1.5},
   {e:"🧱",a:"Duvar Ustası",z:4,   s:"6 harflide 40 kelime",   v:g6.t>=40},
   {e:"🏛",a:"Yedi Sütun",z:5,     s:"7 harflide 15 kelime",   v:g7.t>=15},
   {e:"🌇",a:"Akşamcı",z:1,        s:"akşam 18-22 arası",      v:saatVar(18,22)},
   {e:"☕",a:"Öğle Arası",z:1,     s:"öğlen 12-14 arası",      v:saatVar(12,14)},
   {e:"📈",a:"Yükseliş",z:3,       s:"son 20, önceki 20'den iyi", v:yukselis},
   {e:"🧗",a:"İstikrar",z:3,       s:"3 gün üst üste",         v:enArd>=3},
   {e:"🧪",a:"Çok Yönlü",z:2,      s:"bir günde 4 farklı harf", v:cokYonlu},
   {e:"🥁",a:"Kararlı",z:3,        s:"7 ayrı günde çalışma",   v:gunler>=7},
   {e:"🗿",a:"Sarsılmaz",z:5,      s:"7 gün üst üste",         v:enArd>=7},
   {e:"🎪",a:"Üçlü Gün",z:2,       s:"bir günde 3 farklı uzunluk", v:ucUzunluk},
   {e:"🧯",a:"Zor Gün",z:3,        s:"bir günde 10 kez takılıp devam", v:zorGun},
   {e:"🪄",a:"Sihirbaz",z:4,       s:"5 kelime üst üste ilk tahminde", v:enIlkSeri>=5},
   {e:"🎢",a:"Geri Dönüş",z:3,     s:"5 hatadan sonra 5 doğru", v:geriDonus},
   {e:"🧩",a:"Yapboz",z:5,         s:"6 ve 7 harflide 50 kelime", v:(g6.t+g7.t)>=50},
   {e:"🐎",a:"Koşucu",z:5,         s:"bir günde 200 kelime",   v:enYogun>=200},
   {e:"🕰",a:"Sabah Sporu",z:2,    s:"3 ayrı sabah çalışma",   v:sabahGun.size>=3},
   {e:"🌛",a:"Gece Nöbeti",z:2,    s:"3 ayrı gece çalışma",    v:geceGun.size>=3},
   {e:"🎓",a:"Mezun",z:5,          s:"tüm görevler + 400 kelime",
     v:yapilan>=LG_GOREVSAY && d.length>=400},
   {e:"🏅",a:"Dokuz Harf",z:4,     s:"9 harfte %70+ başarı",   v:iyiHarf>=9},
   {e:"🧠",a:"Hafıza Ustası",z:4,  s:"takıldığın 10 kelimeyi bilmek", v:ikinciSay>=10},
   {e:"🔮",a:"Kahin",z:4,          s:"50 kelime ilk tahminde", v:ilk>=50},
   {e:"🏆",a:"Kupa",z:5,           s:"dört uzunlukta da %70+", v:tumUzunlukIyi},
   {e:"🌍",a:"Tam Alfabe",z:5,     s:"28 harfin hepsinden kelime", v:tumAlfabe},
   /* --- Bir Harf Kalmisti --- */
   {e:"🥾",a:"Yol Yürüyeni",z:3,   s:"bir Likya rotasını bitir",     v:(K.bitirilen||0)>=1},
   {e:"🗿",a:"Yazıtı Okuyan",z:4,  s:"son yazıtı çöz",               v:(K.sonKapi||0)>=1},
   {e:"💧",a:"Son Damla",z:5,      s:"yolu tek matarayla bitir",     v:!!K.tekKalp},
   {e:"🎒",a:"Ağır Çanta",z:3,     s:"bir konakta 4 ürün al",        v:!!K.dortUrun},
   {e:"👣",a:"Yalın Ayak",z:5,     s:"yolu hiç ürün almadan bitir",  v:!!K.urunsuz},
   /* --- Papatya Cayi --- */
   {e:"🌼",a:"Tam Papatya",z:4,    s:"yedi harfin hepsini kullan",    v:(P.tam||0)>=1},
